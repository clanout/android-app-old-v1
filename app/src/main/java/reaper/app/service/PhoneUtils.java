...
/**
 * Created by harsh.pokharna on 2/5/2015.
 */
public class PhoneUtils {
    ...
    public static String getCountryCode(String number) {
        try {
            Phonenumber.PhoneNumber phoneNumber = phoneNumberUtil.parseAndKeepRawInput(number, phoneNumberUtil.getRegionCodeForCountryCode(Integer.parseInt(Constants.DEFAULT_COUNTRY_CODE)));
