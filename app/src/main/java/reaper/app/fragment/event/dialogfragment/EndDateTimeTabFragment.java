 ...
 */
public class EndDateTimeTabFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_end_datetime_tab, container, false);
        datePicker = (DatePicker) view.findViewById(R.id.dpEndDateTime);
        timePicker = (TimePicker) view.findViewById(R.id.tpEndDateTime);
